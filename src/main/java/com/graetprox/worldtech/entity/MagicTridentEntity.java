...
public class MagicTridentEntity extends TridentEntity {
    ...
    public MagicTridentEntity(EntityType<? extends TridentEntity> entityEntityType, World world) {
        super(entityEntityType, world);
        this.setBoundingBox(new Box(1,1,1,2,2,2));
        //this.tridentStack = new ItemStack(Items.TRIDENT);
    }

   /* public MagicTridentEntity(World world, LivingEntity owner, ItemStack stack) {
        super(WorldTech.MAGIC_TRIDENT, owner, world);
        this.tridentStack = new ItemStack(Items.TRIDENT);
    ...
    public MagicTridentEntity(World world, double x, double y, double z) {
        super(WorldTech.MAGIC_TRIDENT, x, y, z, world);
        this.tridentStack = new ItemStack(Items.TRIDENT);
    }
